...
vguardar.addEventListener('click',function(){
	...
	fetch('http://localhost:8080/Practicas_v2_AngelGabriel/php/script_form_libros.php',{
		method:"POST",
		headers:{
...
document.addEventListener('DOMContentLoaded',function(){
	fetch('http://localhost:8080/Practicas_v2_AngelGabriel/php/script_info_libros.php')
	.then(function(respuesta){
		return respuesta.json();
	})
	.then(function(json){
